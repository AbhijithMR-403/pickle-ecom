...
export default function ProductDetails() {
    ...
    return (
        <div className="min-h-screen pb-32 bg-gradient-to-br from-[#bad1c1] via-[#dcd2ac] to-[#f2ecdb] text-text-main relative font-sans selection:bg-brand-primary/20">
            ...
            {/* Top Bar */}
            <div className="flex items-center justify-between p-4 sticky top-0 z-10 pt-safe">
                <button
                    onClick={() => navigate(-1)}
            ...
            <div className="px-5 mb-5 mt-2">
                <div className="rounded-[1.5rem] overflow-hidden shadow-2xl shadow-black/10 h-72 relative mx-auto max-w-sm ring-1 ring-black/5">
                    <img
            ...
            <div className="px-5 mb-6">
                <h1 className="text-[32px] font-serif font-bold text-[#1a0f08] leading-[1.1] mb-5 tracking-tight">Traditional Kerala Mango Pickle</h1>
            ...
            <div className="px-5 mb-8">
                ...
                <p className="text-[15px] leading-relaxed text-[#4a352a] mb-4.5 font-medium pr-2">
                ...
                <p className="text-[15px] leading-relaxed text-[#4a352a] font-medium pr-2 mt-4">
            ...
            {/* Key Ingredients */}
            <div className="px-5 pb-8 relative z-0">
                ...
                <div className="grid grid-cols-2 gap-3.5">
                    {ingredients.map((item, i) => (
                        <div key={i} className="bg-white/60 hover:bg-white/80 transition-colors backdrop-blur-md px-3.5 py-4 rounded-[1.25rem] flex items-center gap-3.5 shadow-sm border border-white/60">
                            ...
                            <span className="text-[13px] font-bold text-[#431407] leading-tight pr-2">{item.name}</span>
                        </div>
                    ))}
                </div>
            </div>
            ...
            {/* Bottom Sticky Bar */}
            <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-gradient-to-t from-[#f4ebe1] via-[#f4ebe1]/95 to-transparent pt-12 p-5 pb-safe z-50 pointer-events-none">
                <div className="flex items-center gap-4 pointer-events-auto bg-white/40 p-2 rounded-full backdrop-blur-xl border border-white shadow-2xl">
