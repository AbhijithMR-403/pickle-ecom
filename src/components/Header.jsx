            ...
            <div className="flex items-center justify-between p-4 md:px-8 max-w-screen-xl mx-auto">
                <Link to="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                    <div className="w-10 h-10 rounded-full bg-orange-100 overflow-hidden border-2 border-orange-200 shadow-sm shrink-0">
                        <img src="https://www.grafixjoker.com/wp-content/uploads/2024/03/Mickey-Mouse.jpg" alt="Profile" className="w-full h-full object-cover" />
                    </div>
                    <h1 className="text-lg md:text-xl font-serif font-bold text-text-main tracking-tight hidden sm:block">
                        Malabar Delights
                    </h1>
                </Link>
